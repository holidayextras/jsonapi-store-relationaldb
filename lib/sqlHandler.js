...
SqlStore.prototype._buildModels = function() {
  ...
  switch (self.config.dialect) {
    case 'postgres':
      modelAttributes = modelGenerators.postgres.joiSchemaToSequelizeModel(localAttributes)
      break;
    default:
      modelAttributes = modelGenerators.default.joiSchemaToSequelizeModel(localAttributes)
  }
